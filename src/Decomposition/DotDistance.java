...
public class DotDistance {
    public  void DotDistance(){
        ArrayList<Double> list = dotDistance(setDots());
        System.out.println(list.toString());
    }
    private static double[] setDots(){
    ...
    private static ArrayList<Double> dotDistance(double[] dots){
    ...
    private static double distBetween(double x1,double y1,double x2, double y2){
